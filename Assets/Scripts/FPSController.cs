...
public class FPSController : MonoBehaviour {
    ...
    public void Update() {
        ...
        //rotate camera
        _cameraRot.x += Input.GetAxis("Mouse X") * (PlayerPrefs.GetInt("Sensitivity") / 10);
        _cameraRot.y = Mathf.Min(89, Mathf.Max(-89, _cameraRot.y + -Input.GetAxis("Mouse Y") * (PlayerPrefs.GetInt("Sensitivity") / 10)));
